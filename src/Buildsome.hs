...
updateGitIgnore buildsome makefilePath = do
  ...
  let dir = FilePath.takeDirectory makefilePath
      ...
      gitIgnoreBasePath = dir </> ".gitignore-base"
      extraIgnored = [buildDbFilename makefilePath, gitignore_base]
  ...
  where
    gitignore_base = ".gitignore-base"
    header = ["# AUTO GENERATED FILE - DO NOT EDIT",
              BS8.concat
             ["# If you need to ignore files not generated by buildsome, add to ", gitignore_base]]
